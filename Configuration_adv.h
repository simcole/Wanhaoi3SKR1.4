...
//
#define NUM_Z_STEPPER_DRIVERS 1   // (1-4) Z options change based on how many USE 1 DRIVER FOR SKR 1.4 AND WANHAO I3 (AKA MONOPRICE MAKER SELECT V2)
...
#define HOMING_BUMP_MM      { 0, 0, 2 }       // (mm) Backoff from endstops after first bump was 5,5,2 by defalt
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       734        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  //MAY HAVE TO CHANGE THIS LATER CHECK BACK
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    //#define Z_STALL_SENSITIVITY  100 because we are using BLTouch at the dedicated BL touch port
