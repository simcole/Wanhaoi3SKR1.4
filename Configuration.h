...
#define STRING_CONFIG_H_AUTHOR "(Adam Coleman, Wanhao i3 aka Maker Select V2 config for SKR 1.4 non-turbo/TMC2209/BLTouch3.X/StockLCD)" // Who made the changes.
...
//Chose 115200 because LCD's typically respond better at lower baudrate but YMMV
...
#define CUSTOM_MACHINE_NAME "I3 SKR-1.4 Frakenstein"
...
//REALLY UNSURE ABOUT WHICH PULLUP RESISTOR MY BED HAS ETC. CHECK THIS LATER IF THERE ARE ISSUES***********
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //SKR1.4-i3
  #define DEFAULT_bedKp 168.07  //Found after my auto PID tune via Octaprint
  #define DEFAULT_bedKi 33.58 //Found after my auto PID tune via Octaprint
  #define DEFAULT_bedKd 560.79 //Found after my auto PID tune via Octaprint
